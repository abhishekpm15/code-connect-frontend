...
import HomePageDarkSS from "../assets/HomePageDarkSS.png";
                ...
                <div className="flex justify-evenly mt-20">
                  <div className="flex flex-col space-y-5">
                    ...
                    <div className="w-[600px] flex flex-col">
                      ...
                      <div className="text-2xl font-semibold mt-5">Bounty</div>
                      <div className="text-lg mt-3 leading-7">
                        ⭐ This is an important aspect of this platform. Provide
                        only suitable bounty for the required work. It can range
                        from 1 unit of currency to a 100 depending on the
                        problem.
                      </div>
                    </div>
                  </div>
                  <div>
                    {theme === "light" ? (
                      <img src={DarkModeSS} className="w-[700px]" />
                    ) : (
                ...
                <div className="flex justify-evenly mt-20 items-center">
                  <div>
                    <div className="flex flex-col space-y-5">
                      ...
                      <div className="text-xl w-[600px] leading-7">
                        You can view others as well as your post in the
                        Homepage.
                      </div>
                      <div className="text-xl w-[650px] leading-7">
                        ⭐ Select post that you know better and help others to
                        resolve their problem.
                      </div>
                      <div className="text-xl w-[650px] leading-7">
                        ⭐ You can anytime update or turn off the post if your
                        doubt is clarified.
                      </div>
                      <div className="text-xl w-[650px] leading-7">
                        ⭐ Once signed in Update your profile, so that others
                        can see your tier.
                      </div>
                    </div>
                    <div className="text-2xl flex justify-center w-[600px] mt-10 font-semibold">
                      Finally, respect the platform
                    </div>
                  </div>
                  <div>
                    {theme === "light" ? (
                      <img src={HomePageDarkSS} className="w-[700px]" />
                    ) : (
